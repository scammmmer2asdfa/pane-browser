...
- Adjustable accent, font, corner radius, glass blur, animation level, and light/dark/system appearance
...
Top, left, and right tab layouts use Gecko's native toolbar/sidebar controls. Tabs can be detached by dragging them into a new window. The floating hover tab strip remains browser-chrome work and is represented by Pane's preference model but is not complete in this initial build.
